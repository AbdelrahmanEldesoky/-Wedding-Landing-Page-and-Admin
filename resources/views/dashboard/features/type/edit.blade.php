        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="{{ route('dashboard.type.update',$type->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('put') }}
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>الوصف</label>
                  <input class="form-control" name="description" value="{{$type->description}}" rows="3">
                </div>
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" name="is_active" @if ($type->is_active == 1)
                    checked value="1"
                    @else
                    value ="0"
