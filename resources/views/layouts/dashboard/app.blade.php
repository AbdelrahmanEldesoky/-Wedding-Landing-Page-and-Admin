...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('dashboard/plugins/summernote/summernote-bs4.min.css')}}">
    ...
    <!--########## New############ -->
    <link rel="stylesheet" href="{{ asset('dashboard/plugins/fullcalendar/main.css')}}">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a>AdminLTE.io</a>.</strong>
    All rights reserved.
...
<script src="{{ asset('dashboard/plugins/fullcalendar/main.js')}}"></script>
