...
{{-- start ttitle page --}}
<title>Browse Suit and accessories</title>
{{-- end title page --}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 p-5">
                    <h1 class="page-section-heading text-center  title_content mb-0 font_cherry"> Suit and accessories </h1>
                ...
                <div class="col-12 d-flex text-end  justify-content-end">
                    {{-- URL suit page --}}
                    <a href="{{ route('farah.browse.wedding.browse_decorations') }}"
